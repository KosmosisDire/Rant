...
//         var node = new RantNode("cs-subscriber", new NodeOptions { MulticastInterface = iface,
//                                                                    Threading = Threading.Manual });
//         node.Events += e => Console.Error.WriteLine("event: " + e);
//         node.Subscriber<Tick>("tick", t => { _count++; _last = t; });
